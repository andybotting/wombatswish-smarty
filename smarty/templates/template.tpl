			...
			<div id="header">
				...
				<div id="social">
					<a href="http://www.facebook.com/WombatsWish">
                        <img src="{$base_url}/img/facebook_icon.png" alt="Facebook" width="40" height="40" border="0" />
                    </a>
                    <a href="http://www.twitter.com/WombatsWish">
                        <img src="{$base_url}/img/twitter_icon.png" alt="Twitter" width="40" height="40" border="0" />
                    </a>
				</div>
				<div id="slogan">
