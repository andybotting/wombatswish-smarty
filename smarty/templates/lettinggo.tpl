...
{capture name="body"}
	<div id="fullcolumn">
        ...
        <h3>Results</h3>
        <ul>
            <li><b>First Place:</b> Bridget Taylor - Mother Duck</li>
            <li><b>Second Place:</b> Isobella Northeast - The Aftermath of Grief</li>
            <li><b>Third Place:</b> Rochelle Erwin - Cinderella's Reality</li>
            <li><b>Primary Winner:</b> Ellen Braley - Letting Go (Death of a Special Auntie)</li>
        </ul>

        <h3>Highly Commended Awards</h3>
        <ul>
            <li>Grace Athanatos - Jayden</li>
            <li>Kara Baker - Poem dedicated to two Nanas</li>
            <li>Jasmine Davis - Letting Go (Death of a Friend)</li>
            <li>Darci Allen - The Way Back</li>
            <li>Lachlan Mibus - Matilda</li>
        </ul>
