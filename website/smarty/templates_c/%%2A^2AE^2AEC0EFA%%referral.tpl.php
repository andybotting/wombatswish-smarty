<?php /* Smarty version 2.6.19, created on 2012-06-06 18:15:47
         compiled from referral.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'mailto', 'referral.tpl', 8, false),)), $this); ?>
<?php ob_start(); ?>Wombat's Wish Referral Form<?php $this->_smarty_vars['capture']['title'] = ob_get_contents(); ob_end_clean(); ?>

<?php ob_start(); ?><script src="<?php echo $this->_tpl_vars['base_url']; ?>
/js/validate.js" type="text/javascript" language="JavaScript"></script><?php $this->_smarty_vars['capture']['head'] = ob_get_contents(); ob_end_clean(); ?>

<?php ob_start(); ?>
	<div id="centercolumn" style="width:700px;">

		<p>You can email us at <?php echo smarty_function_mailto(array('address' => "referrals@wombatswish.org.au",'encode' => 'hex'), $this);?>
 or use the form below:</p>

		<form method="post" action="<?php echo $this->_tpl_vars['base_url']; ?>
/referralform.php" onsubmit="return checkFields()">
